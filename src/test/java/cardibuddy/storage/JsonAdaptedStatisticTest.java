...
public class JsonAdaptedStatisticTest {
    ...
    private final HashMap<String, List<Double>> VALID_HISTORY = new HashMap<>();
    ...
    public void toModelType_invalidInt_throwsNumberFormatException() {
        JsonAdaptedStatistic statistic = new JsonAdaptedStatistic(INVALID_NUM, VALID_INT, VALID_INT, VALID_INT, VALID_INT,
               VALID_INT, VALID_DOUBLE, VALID_DOUBLE, VALID_HISTORY);
