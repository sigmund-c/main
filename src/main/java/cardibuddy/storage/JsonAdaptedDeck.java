...
public class JsonAdaptedDeck extends JsonAdaptedView{
     ...
     */
         ...
         */
        @JsonCreator
        public JsonAdaptedDeck(@JsonProperty("title") String title, @JsonProperty("flashcards") List<JsonAdaptedFlashcard> flashcards,
        ...
        public JsonAdaptedDeck(Deck source) {
            ...
            flashcards.addAll(source.getFlashcards().stream().map(cardibuddy.storage.JsonAdaptedFlashcard::new).collect(Collectors.toList()));
