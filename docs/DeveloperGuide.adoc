...
* The `TestSession` object updates Cardibuddy's `UniqueFlashcardList` to display the first flashcard in the queue, along with the other flashcards to be tested.
