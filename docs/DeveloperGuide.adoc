...
* Ability to type in answers

Cons:

* Answers need to be written word for word to be marked as correct
* Unable to view a full list of cards the user got wrong, and cards the user got right
* More steps needed to create a flash card
** eg. 
