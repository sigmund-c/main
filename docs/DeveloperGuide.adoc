...
|`* * *`|student studying for finals|immediately see the questions/flashcards that I get right|know what content I am more familiar with

|`* * *`|student studying for finals|test flashcards that I got wrong more often|better remember the content
