...
** Justification: This feature improves the product significantly - a flashcard application can not be without a testing feature. In addition, this feature provides enhancements on top of basic testing - such as retesting, skipping and the ability to force correct answers.
...
include::../UserGuide.adoc[tags=test]
