...
* CardiBuddy will not note down this flashcard in your test history, and will merely remove it from your current test session.

==== Force correct an answer: `force`

What it does:

* CardiBuddy takes your answer word for word when checking against the flashcard's model answer.
