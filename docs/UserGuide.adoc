...
* `open 1` +
`add p/file:/Users/haveaqiupill/Documents/GitHub/cs2103/main/docs/images/ArchitectureSequenceDiagram.png c/1 q/What type of UML diagram is this? a/Architecture Diagram` +
