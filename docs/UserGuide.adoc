...
// tag::addingImage[]
==== Adding an image card: `add p/file:FILE_PATH_TO_IMAGE c/DECK_INDEX q/QUESTION a/ANSWER`
...
==== Adding an image card via the Image button: `c/DECK_INDEX q/QUESTION a/ANSWER`
...
* *Add normal card* : `add c/DECK_INDEX q/QUESTION a/ANSWER` +
e.g. `add c/1 q/What does OOP stand for? a/Object Oriented Programming`
* *Add image card* : `add p/file:FILE_PATH_TO_IMAGE c/DECK_INDEX q/QUESTION a/ANSWER` +
