...
* `open 1` +
`add p/file:/Users/qiujingying/Documents/GitHub/cs2103/main/docs/images/ArchitectureDiagram.png q/What type of diagram is this? a/Architecture Diagram` +
Adds a new card with an image belonging to the opened deck.
